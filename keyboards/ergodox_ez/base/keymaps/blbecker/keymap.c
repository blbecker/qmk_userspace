 ...
 * | Reset  |      |      |      |      |      |      |           |      |      |      |      |      |            |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------------+--------|
 * |        |      |      |      |      |      |Ctrl+ |           | Alt+ | Home | PgUp |PgDown| End  |AltShftPgUp |        |
 * |--------+------+------+------+------+------|ShftUp|           |ShftUp|------+------+------+------+------------+--------|
 * |        |      |AltLft|AltDwn|AltUp |AltRgt|------|           |------| Left | Down | Up   |Right |AltShftPgDn |        |
 * |--------+------+------+------+------+------|Ctrl+ |           | Alt+ |------+------+------+------+------------+--------|
 * |        |      |      |      |      |      |ShftDn|           |ShftDn|      |      |      |      |            |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |            |      |
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  _______, _______, _______, _______, _______, _______, _______,     _______, _______, KC_LBRC, KC_RBRC, KC_MINS,  KC_EQL, _______,
  _______, _______, _______, _______, _______, _______,                       _______, KC_LCBR, KC_RCBR, KC_UNDS, KC_PLUS, _______,
  _______, _______, _______, _______, _______, _______, _______,     _______, _______, KC_LPRN, KC_RPRN, KC_TILD,  KC_GRV, _______,
  _______, _______, _______, _______, _______,                                         _______, _______, _______, _______, _______,
...
[NUM] = LAYOUT_ergodox_pretty(
  // left hand                                                                                                          Right Hand
  _______, _______, _______, _______, _______, _______, _______,     _______, _______,  KC_NUM, KC_PSLS, KC_PAST, _______, _______,
  ...
  _______, _______, _______, _______, _______,                                         KC_KP_0, KC_PDOT, KC_PENT, _______, _______,
